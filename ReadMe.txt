1. 学
    1.文件夹c
        1. 功能
            1. shell.cc文件实现加载并执行js文件
                1. 进入c目录，运行命令行【通过执行CMake和make编译，配置文件为CMakeLists.txt】
                    ...
                    9. 执行hello.js中移动棋子指令，会看到棋局移动：receiveOrderStr(15)或者handleOrder(1,5)
    ...
    3. 文件夹js
        1. 功能
            1. js实现对角棋功能【主体功能在hello.js，测试入口为hello-test.js】
