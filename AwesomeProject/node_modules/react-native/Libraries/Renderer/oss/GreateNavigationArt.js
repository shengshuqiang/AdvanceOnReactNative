...
function hookClassInstance(clazz) {
    return function (nextProps, prevState) {
        ...
        try {
            this.prototype = new clazz(nextProps, prevState);
        } finally {
            popRunRecordStack();
        }

        if (getDerivedStateFromProps) {
            clazz.prototype.getDerivedStateFromProps = function (nextProps, prevState) {
        ...
        if (UNSAFE_componentWillMount) {
            clazz.prototype.UNSAFE_componentWillMount = function () {
        ...
        if (componentWillReceiveProps) {
            clazz.prototype.componentWillReceiveProps = function (newProps, nextContext) {
        ...
        if (UNSAFE_componentWillReceiveProps) {
            clazz.prototype.UNSAFE_componentWillReceiveProps = function (newProps, nextContext) {
        ...
        if (shouldComponentUpdate) {
            clazz.prototype.shouldComponentUpdate = function (newProps, newState, nextContext) {
        ...
        if (componentWillUpdate) {
            clazz.prototype.componentWillUpdate = function (newProps, newState, nextContext) {
        ...
        if (UNSAFE_componentWillUpdate) {
            clazz.prototype.UNSAFE_componentWillUpdate = function (newProps, newState, nextContext) {
        ...
        if (getSnapshotBeforeUpdate) {
            clazz.prototype.getSnapshotBeforeUpdate = function (prevProps, prevState) {
        ...
        if (componentDidUpdate) {
            clazz.prototype.componentDidUpdate = function (prevProps, prevState, snapshot) {
        ...
        if (isReactComponent) {
            clazz.prototype.isReactComponent = function () {
