...
function createWorkInProgress(current, pendingProps, expirationTime) {
    pushRunRecordStack('createWorkInProgress');
    try {
...
function beginWork(current$$1, workInProgress, renderExpirationTime) {
    pushRunRecordStack(`beginWork(current${current$$1 ? current$$1.id : -1}, workInProgress${workInProgress ? workInProgress.id : -1})`);
    try {
