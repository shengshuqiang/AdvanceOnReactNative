...
function ChildReconciler(shouldTrackSideEffects) {
    ...
    // try {
        ...
        function reconcileChildFibers(
            ...
            pushRunRecordStack('reconcileChildFibers');
            try {
    ...
    try {
        ...
        if (isYieldy) {
            ...
            while (
              ...
              pushRunRecordStack('nextFlushedRoot !== null && nextFlushedExpirationTime !== NoWork && minExpirationTime <= nextFlushedExpirationTime && !(shouldYield$$1() && currentRendererTime > nextFlushedExpirationTime');
              try {
                performWorkOnRoot(
                  nextFlushedRoot,
