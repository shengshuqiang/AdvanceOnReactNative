...
function hookClassInstance(ctor) {
    if (ctor) {
        const {
            constructor,
            getDerivedStateFromProps,
        ...
        if (getDerivedStateFromProps) {
            ctor.getDerivedStateFromProps = function (nextProps, prevState) {
        ...
        if (componentWillMount) {
            ctor.componentWillMount = function () {
        ...
        if (UNSAFE_componentWillMount) {
            ctor.UNSAFE_componentWillMount = function () {
        ...
        if (componentWillReceiveProps) {
            ctor.componentWillReceiveProps = function (newProps, nextContext) {
        ...
        if (UNSAFE_componentWillReceiveProps) {
            ctor.UNSAFE_componentWillReceiveProps = function (newProps, nextContext) {
        ...
        if (shouldComponentUpdate) {
            ctor.shouldComponentUpdate = function (newProps, newState, nextContext) {
        ...
        if (componentWillUpdate) {
            ctor.componentWillUpdate = function (newProps, newState, nextContext) {
        ...
        if (UNSAFE_componentWillUpdate) {
            ctor.UNSAFE_componentWillUpdate = function (newProps, newState, nextContext) {
                pushRunRecordStack('UNSAFE_componentWillUpdate');
                try {
                    UNSAFE_componentWillUpdate(newProps, newState, nextContext);
                } finally {
                    popRunRecordStack();
                }
            }
        ...
        if (getSnapshotBeforeUpdate) {
            ctor.getSnapshotBeforeUpdate = function (prevProps, prevState) {
        ...
        if (componentDidMount) {
            ctor.componentDidMount = function () {
        ...
        if (componentDidUpdate) {
            ctor.componentDidUpdate = function (prevProps, prevState, snapshot) {
        ...
        if (componentWillUnmount) {
            ctor.componentWillUnmount = function () {
...
function dumpFiberTree(desc, currentFiberID) {
    ...
    console.log('SSU', 'dumpFiberTree()', {roots, instanceCache, doms});
    // debugger;
}
